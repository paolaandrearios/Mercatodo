        ...
        <div class="container mx-auto p-12">
            <div class="checkout">
                <div class="flex flex-col md:w-full">
                    <h2 class="text-heading mb-4 font-bold md:text-xl">
                        {{ __('general.web.order.shipping_information') }}
                    </h2>
                    <form v-on:submit.prevent="" class="mx-auto w-full justify-center">
                        <div class="">
                            <div class="space-x-0 lg:flex lg:space-x-4">
                                <div class="w-full lg:w-1/2">
                                    ...
                                    <input
                                        ...
                                        id="first_name"
                                        type="text"
                                        :placeholder="__('general.web.order.first_name')"
                                ...
                                <div class="w-full lg:w-1/2">
                                    ...
                                    <input
                                        ...
                                        id="last_name"
                                        type="text"
                                        :placeholder="__('general.web.order.last_name')"
                            ...
                            <div class="mt-3 space-x-0 lg:flex lg:space-x-4">
                                <div class="w-full lg:w-1/2">
                                    ...
                                    >
                                        <select
                                            ...
                                            name="document_type"
                                            id="document_type"
                                            v-model="shipping.document_type"
                                        >
                                ...
                                <div class="w-full lg:w-1/2">
                                    ...
                                    <input
                                        ...
                                        id="document_number"
                                        type="text"
                                        :placeholder="__('general.web.order.document_number')"
                                        v-model="shipping.document_number"
                                        class="checkout__input focus:ring-1 focus:ring-blue-600"
                                    />
                                </div>
                            ...
                            <div class="mt-4">
                                <div class="w-full">
                                    ...
                                    <input
                                        ...
                                        id="email"
                                        type="text"
                                        :placeholder="__('general.web.order.email')"
                            ...
                            <div class="mt-4">
                                <div class="w-full">
                                    ...
                                    <textarea
                                        ...
                                        cols="20"
                                        rows="4"
                                        :placeholder="__('general.web.order.address')"
                                    ></textarea>
                                </div>
                            ...
                            <div class="space-x-0 lg:flex lg:space-x-4">
                                <div class="mt-3 w-full lg:w-1/2">
                                    ...
                                    <input
                                        ...
                                        id="city"
                                        type="text"
                                        :placeholder="__('general.web.order.city')"
                                ...
                                <div class="mt-3 w-full lg:w-1/2">
                                    ...
                                    <input
                                        ...
                                        id="postcode"
                                        type="text"
                                        :placeholder="__('general.web.order.postcode')"
                            ...
                            <div class="mt-3 w-full lg:w-1/2">
                                ...
                                <input
                                    ...
                                    id="phone"
                                    type="text"
                                    :placeholder="__('general.web.order.phone')"
                            ...
                            <div class="relative pt-3 xl:pt-6">
                                ...
                                ><textarea
                                    ...
                                    rows="4"
                                    :placeholder="__('general.web.order.notes_delivery')"
                                ></textarea>
                            </div>
                            <error :errors="__e(errors, 'shipping.notes')"></error>
                            <div class="mt-4">
                                <button
                                    class="checkout__button--process"
                                    :class="cartItems.length === 0 ? 'disabled' : ''"
                                    :disabled="cartItems.length === 0"
                                    v-on:click="create"
                                >
                                    <div v-if="show_spin">
                                        <svg class="... mr-3 h-5 w-5 animate-spin text-gray-200" viewBox="0 0 100 101">
                                            <path
...
export default {
    ...
    methods: {
        create: function () {
            ...
            axios
                .post('/evertec/mercatodo/public/api/client/orders', data)
                .then((response) => {
