            ...
            >
                <div class="modal__content">
                    ...
                    <div class="flex justify-between">
                        <button class="flex justify-center w-1/2 px-4 py-2 m-2 text-white bg-orangePantone hover:bg-orange-600 rounded-xl hover:bg-greenTem focus:bg-greenTem focus:outline-none items-center" @click="click">
                            <div v-if="show_spin">
                        ...
                        <button class="flex justify-center w-1/2 px-4 py-2 m-2 text-white bg-gray-400 hover:bg-gray-600 rounded-xl hover:bg-gray-400 focus:outline-none items-center" @click="close()">
                            <div>
