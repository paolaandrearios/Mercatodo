        ...
        <template v-slot:body>
            <form v-on:submit.prevent="" class="form">
                <div class="div-form">
                    ...
                    <div class="div-input">
                        <input name="name_es" type="text" id="name_es" v-model="category.name_es" required minlength="4" maxlength="60">
                ...
                <div class="div-form">
                    ...
                    <div class="div-input">
                        <input name="name_en" type="text" id="name_en" v-model="category.name_en" required minlength="4" maxlength="60">
                ...
                <div class="form-file">
                    ...
                    <div class="div-input">
                        <input name="outstanding_image" type="file" id="outstanding_image" ref="fileupload" v-on:change="onChange" accept="image/png,image/jpeg,image/jpg" required>
