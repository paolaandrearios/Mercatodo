...
return [
    ...
    'web' => [
        ...
        'user' => [
            ...
            'client' => 'Cliente',
            'stock_assistant' => 'Asistente de Inventario',
            'financial_assistant' => 'Asistente Financiero',
            'logistic_assistant' => 'Asistente Logístico',
        ...
        'data_management' => [
            ...
            'select_report_type' => 'Seleccione tipo de reporte',
            'most_visited_products' => 'Los 10 productos más visitados',
            'report_most_visited_products' => 'Reporte de los 10 productos más visitados',
            'number_of_visits' => 'Número de visitas',
            'quantity_of_products' => 'Cantidad de productos',
            'sold_products' => 'Productos vendidos',
            'least_visited_products' => 'Los 10 productos menos visitados',
            'report_least_visited_products' => 'Reporte de los 10 productos menos visitados',
            'best_selling_products' => 'Los 10 productos más vendidos',
            'report_best_selling_products' => 'Reporte de los 10 productos más vendidos',
            'least_sold_products' => 'Los 10 productos menos vendidos',
            'report_least_sold_products' => 'Reporte de los 10 productos menos vendidos',
            'abandoned_carts' => 'Carritos abandonados',
            'report_abandoned_carts' => 'Reporte Carritos Abandonados',
            'best_selling_categories' => 'Categorías más vendida',
            'report_best_selling_categories' => 'Reporte categorías más vendidas',
            ...
            'success_email_description' => 'Te informamos que los productos del archivo ":fileName", fueron exitosament importados.',
            'error_mail_products' => 'Los productos no pudieron ser importados (archivo: :fileName)',
            'success_mail_products' => 'Los productos fueron exitosamente importados (archivo: :fileName)',
            'success_mail_exported_products' => 'Productos exitosamente exportados (Archivo: :fileName)',
            'success_mail_report_generated' => 'Reporte generado exitosamente (Archivo: :fileName)',
            'go_store' => 'Ir a la tienda',
            'download_file' => 'Descargar Archivo',
            'success_export_email_description' => 'Te informamos que los productos solicitados fueron exportados con éxito, a continuación encontrarás un botón para su descarga, archivo ":fileName".',
            'success_report_email_description' => 'Te informamos que el informe solicitado fue generado con éxito, a continuación encontrarás un botón para su descarga, archivo ":fileName".',
        ],
    ],
